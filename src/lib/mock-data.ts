...
export const studentRecords: StudentRecord[] = [
  {
    ...
    reportCard: {
      ...
      entries: [
        { questionId: "default-category", fieldKey: "category", label: "Kategori", inputType: "text", value: "Mini Ice", sortOrder: 10 },
        { questionId: "default-club-name", fieldKey: "club_name", label: "Kulup", inputType: "text", value: "Elit Kids Akademi", sortOrder: 20 },
        ...
        { questionId: "default-strengths", fieldKey: "strengths", label: "Guclu yonler", inputType: "textarea", value: "Buz ustu denge ve dikkat.", sortOrder: 60 },
  ...
  },
  {
    ...
    reportCard: {
      ...
      entries: [
        { questionId: "default-category", fieldKey: "category", label: "Kategori", inputType: "text", value: "Artistik", sortOrder: 10 },
        { questionId: "default-club-name", fieldKey: "club_name", label: "Kulup", inputType: "text", value: "Elit Kids Akademi", sortOrder: 20 },
